...
// Styles
import styles from "./MarkdownPreviewerApp.module.css";
// Components
import Button from "../HomeButton/Button";

const MarkdownPreviewerApp: React.FC = () => {
  ...
  const rawValueChangeHandler = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
